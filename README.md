...
[![Travis Build](https://travis-ci.org/arkadyb/go-proto-validators.svg)](https://travis-ci.org/arkadyb/go-proto-validators)
...
```sh
go get github.com/arkadyb/go-proto-validators/protoc-gen-govalidators
```
